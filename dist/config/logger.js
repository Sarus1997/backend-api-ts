...
exports.logServerRunning = exports.logServerError = exports.logServerBanner = void 0;
...
const logServerBanner = async () => {
  ...
  `;
    ...
    //* แสดงผลเฟรมแบนเนอร์
    //* แบบ ที่ 1
    await Promise.all(bannerLines.map((line, index) => new Promise((resolve) => {
        setTimeout(() => {
            console.log(line);
            resolve();
...
const logServerRunning = async (port) => {
    await (0, exports.logServerBanner)();
    let i = 0;
